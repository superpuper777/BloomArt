  ...
  <div>
    <form @submit.prevent="uploadImage" class="form">
      <label class="custum-file-upload" for="fileInput">
        ...
        <input type="file" id="fileInput" ref="fileInput" class="file-input" @change="handleFileChange" />
      </label>

      <div v-if="fileName">
        <p>File selected: <span class="file-name">{{ fileName }}</span></p>  <!-- Отображаем имя файла -->
      </div>
